...
$gallery_query = "SELECT * FROM gallery LIMIT $start, $limit";
$gallery = mysqli_query($conn, $gallery_query);

$total_query = "SELECT COUNT(*) FROM gallery";
                    ...
                    <div class="table-responsive p-0">
                        ...
                        <div class="d-flex justify-content-end mx-3">
                            ...
                            <button type="button" class="btn bg-gradient-primary" data-bs-toggle="modal" data-bs-target="#exampleModalSignup">
                                ...
                                <span class="mb-0"> Tambah Foto</span>
                            </button>
                            <!-- Modal -->
                                            ...
                                            <div class="card card-plain">
                                                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                                    <div class="bg-gradient-primary shadow-primary border-radius-xl py-3 pe-1 text-center py-4">
                                                        <h4 class="font-weight-bolder text-white mt-2">TAMBAH FOTO
                                                        </h4>
                                                    </div>
                                                </div>
                                                <div class="card-body pb-3">
                                                    <form action="controller/code.php" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="input-group input-group-outline mb-3">
                                                            <textarea rows="5" name="deskripsi" class="form-control mx-1" placeholder="Deskripsi Foto" required></textarea>
                                                        </div>
                                                        <div class="text-center">
                                                            <button type="submit" name="add_gallery" class="btn bg-gradient-primary w-100 mt-4 mb-3">
                                                                Tambah Foto</button>
                                                        </div>
                                                    </form>
                                                </div>
                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                ...
                                if (mysqli_num_rows($gallery) > 0) {
                                    while ($item = mysqli_fetch_array($gallery)) {
                                ?>
                                        <tr>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <img src="../assets/images/gallery/<?= $item['image'] ?>" width="50px" alt="<?= $item['deskripsi'] ?>">
                                            </td>
                                            <td>
                                                <p class="text-center text-sm font-weight-bold mb-0">
                                                    <?= $item['deskripsi'] ?></p>
                                            ...
                                            <td class="align-middle text-center">
                                                ...
                                                <button type="button" class="btn bg-gradient-primary mb-0" data-bs-toggle="modal" data-bs-target="#editgallery<?= $item['id'] ?>">
                                                    EDIT
                                                </button>
                                                <!-- Button trigger modal Delete-->
                                                <button type="button" class="btn bg-gradient-dark mb-0" data-bs-toggle="modal" data-bs-target="#deletegallery<?= $item['id'] ?>">
                                                    HAPUS
                                                </button>
                                            </td>
                                            <!-- MODAL EDITt gallery -->
                                                                ...
                                                                <div class="card-body pb-3">
                                                                    <form action="controller/code.php" method="POST" enctype="multipart/form-data">
                                                                        ...
                                                                        <div class="input-group input-group-outline mb-3">
                                                                            ...
                                                                            <img src="../assets/images/gallery/<?= $item['image'] ?>" alt="" width="50px">
                                                                        </div>
                                                                        <div class="input-group input-group-outline mb-3">
                                                                            <textarea rows="4" type="text" name="deskripsi" class="form-control mx-1" placeholder="Deskripsi" required><?= $item['deskripsi'] ?></textarea>
                                                                        </div>
                                                                        <div class="text-center">
                                                                            <button type="submit" name="update_gallery" class="btn bg-gradient-primary w-100 mt-4 mb-3">EDIT
                                                                                GALLERY
                                                                            </button>
                                                                        </div>
                                                                    </form>
                                            ...
                                            <div class="modal fade" id="deletegallery<?= $item['id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="controller/code.php" method="POST">
                                                            <div class="modal-body">
                                                                <p class="text-center text-sm font-weight-bold mb-0">Apakah Anda
                                                                    yakin Ingin Menghapus Foto <?= $item['deskripsi'] ?> ?
                                                                </p>
                                                            </div>
                                                            <div class="modal-footer justify-content">
                                                                ...
                                                                <button type="submit" name="hapus_gallery" class="btn bg-gradient-primary mb-0">Hapus</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
